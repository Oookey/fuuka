    ...
    <main id="cuisine" class="subpage">
        ...
        <div class="content bg_wave cuisine_content">
            <div class="inner img_bg_3">
                <!-- アニメーション -->
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 620 500" width="100%" id="blobSvg" filter="blur(0px)" transform="rotate(0)" class="cuisine_mask cuisine_mask1">
