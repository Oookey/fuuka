    ...
    <main id="hos" class="subpage">
            ...
            <div class="inner">
                ...
                <div class="float-r con_text-r fadein">
                    <p class="text">
                        ...
                        美味しいと評判です。<br class="sp">ヤギさんと遊ぶお子様を眺めながら食べるピザは最高ですよ！
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="inner">
                ...
                <div class="float-r con_text-r fadein">
                    <p class="text">
                        ...
                        夕食はフレンチのコース料理。<br>
                        肉と魚のWメイン、お箸で食べるカジュアルフレンチです。「風」と「香」の２コースをご用意しております。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content bg_wave hos_c hos_c5 hos_a">
            <div class="inner">
                ...
                <div class="float-l con_text-l fadein">
                    <p class="text">
                        約50種類のドリンクをお楽しみにいただけます。ビール、ウイスキーもありますが、特に山梨県産ワインを中心にワインが充実しています。
                    </p>
                </div>
        ...
        <div class="content bg_wave hos_c hos_c1">
            <div class="inner">
                ...
                <div class="float-l con_text-l fadein">
                    <p class="text">
                        ヤギさん親子ハナちゃん、ユキちゃんと姪っ子ふうちゃんと、お散歩、餌やり体験が出来ます。<br class="sp">お子様だけでなく大人の方にも大人気です。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content hos_c hos_bg-1 hos_c2">
            <div class="inner">
                ...
                <div class="float-r con_text-r fadein">
                    <p class="text">
                        大きな焚き火での焼きマシュマロはお子様に大人気。表面サクサク中とろとろで大人が食べても、とても美味しいですよ。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content hos_c hos_bg-1 hos_c4">
            <div class="inner">
                ...
                <div class="float-r con_text-r fadein">
                    <p class="text">
                    お子様むけウエルカムドリンクとして各種ソフトドリンク、ココア、カフェオレをご用意。ロイヤルミルクティなどのプレミアムドリンクは16:30までです。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content bg_wave hos_c hos_c7">
            <div class="inner">
                ...
                <div class="float-l con_text-l fadein">
                    <p class="text">
                    フレンチのホテルらしいお子様プレートをご用意。もちろんお子様もフリードリンク。大人のかたがゆったりコース料理を楽しめるよういろんなおもちゃをご用意しております。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content hos_c hos_bg-1 hos_c8">
            <div class="inner">
                ...
                <div class="float-r con_text-r fadein">
                    <p class="text">
                        ナイトBARではノンアルコールのカクテルをご用意。少し背伸びしていつもと違うドリンクはいかが？星見テラスのたき火と星空も、<br class="pc">お子様の貴重な体験になりますよ。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content hos_c hos_bg-1 hos_c10">
            <div class="inner">
                <div class="con-sp-fv fadein">
                    ...
                    <div class="float-r con_text-r">
                        <div class="con_title">
                            <h2>記念日旅行も<br>風かにおまかせ！<br>記念日のおもてなし</h2>
                            <p></p>
                        </div>
                    </div>
                </div>
