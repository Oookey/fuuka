...
get_header(); ?>
    ...
    <main id="top">
        ...
        <div class="top_topic_news">
                                    ...
                                    <a href="<?php echo get_permalink(); ?>" class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 10" style="margin-right: 32px;">
                                        <article class="slide">
                                            ...
                                            <div class="slide-content">
                                                ...
                                                <p class="slide-detail"><?php the_field('topic_detail_toppage_info'); ?><span class="text_limit"></span></p>
                                            </div>
                                        </article>
                                    </a> 
            ...
            <!-- news -->
            <?php
            query_posts('post_type=news&posts_per_page=1&orderby=date&order=DESC');
            while (have_posts()) : the_post();
            ?>
            ...
            <div class="inner">
                ...
                <div class="concept">
                    ...
                    <div class="float-r fadein">
                        <p>
                            1000Mのおもてなし<br>
                            ご家族、恋人、お友達との「思い出旅」は風かにおまかせ。標高1000ｍの天空リゾート、自然豊かな八ヶ岳にあるホテル風かでしか体験できないたくさんのおもてなしを満喫していただき、大切な方との一生の思い出を紡いでください。<br><br>
        ...
        <!-- お知らせ -->
            <div class="news">
                <div class="inner fadein">
                    ...
                    <dl class="">
                        <?php
                        query_posts('post_type=news&posts_per_page=5&orderby=date&order=DESC');
                        while (have_posts()) : the_post();
                        ?>
